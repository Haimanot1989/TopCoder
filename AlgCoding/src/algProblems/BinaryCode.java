...
public class BinaryCode {
	...
	public static void main(String[] args){
		...
		String[] s = bc.decode("12221112222221112221111111112221111");
		System.out.print(s[0] + ", " + s[1]);
		System.out.print(s[0].equalsIgnoreCase("01101001101101001101001001001101001"));
	}


	public String[] decode(String message){
		String[] s = {decode(0, message), decode(1, message)};
		return s;
	}
	
	private String decode(int p, String message){
		int[] Q = convertToInt(message);
		String a = "" + p;
		int p0, p1, p2;
		int message_length = message.length();
		int[] P = new int[message_length];
		...
		int last_element = Q[message_length-1] - P[message_length-2];
		P[message_length-1] = last_element;
		
		if(last_element < 0)
			return "NONE";
		a += "" + (Q[message_length-1] - P[message_length-2]);
		return a;
	}
	
	private int[] convertToInt(String a){
		int a_length = a.length();
		int[] a_int = new int[a_length];
